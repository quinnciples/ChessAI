...
class BitBoardChess:
    ...
    def generate_horizontal_moves(self, board_position: int, color: int) -> int:
...
chess_board.generate_horizontal_moves(29, color=BitBoardChess.WHITE)
